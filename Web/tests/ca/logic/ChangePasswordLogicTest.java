...
{	
	...
	{
		this.theChangePasswordLogic = new ChangePasswordLogic("123456123123","123456789",3);
		assertTrue(this.theChangePasswordLogic.changePassword());
		this.theChangePasswordLogic = new ChangePasswordLogic("123456789","123456123123",3);
		assertTrue(this.theChangePasswordLogic.changePassword());
	}
