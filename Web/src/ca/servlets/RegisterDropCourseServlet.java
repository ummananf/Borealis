...
public class RegisterDropCourseServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		System.out.println("RegisterDropCourseServlet: " + userId + " "
				+ action + " " + course + " " + section + " " + startDate);
		String test = "INSERT INTO Enrolled VALUES (" + userId + ",'" + crn
				+ "', '" + section + "', '" + course + "', '" + startDate
				+ "', NULL);";
		...
		if (action.equals("register")) {
			query = "INSERT INTO Enrolled VALUES (" + userId + ",'" + crn
					+ "', '" + section + "', '" + course + "', '" + startDate
					+ "', NULL);";
			...
			query = "DELETE FROM Enrolled WHERE userID='" + userId
					+ "' AND crn='" + crn + "';";
