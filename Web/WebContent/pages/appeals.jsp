...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>appeals</title><link href="Style/StudentStyle.css" rel="stylesheet" type="text/css" /><link href="Script/jBox/Skins/Blue/jbox.css" rel="stylesheet" type="text/css" /><link href="Style/start.css" rel="stylesheet" type="text/css" />
...
<h2 class="pathNavigator">my info &gt; appeals</h2>
...
<ul id="ulStudMsgHeadTab">
    ...
    <li><a class="tab2" onclick="" href="Objection.aspx">appeals</a></li>
</ul>
...
<div class="workingSpace">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="height: 28px" class="tdbg" align="center">
            <td colspan="13" align="left" style="color: Red; font-weight:bold;">no appeals found!</td>
        </tr>
